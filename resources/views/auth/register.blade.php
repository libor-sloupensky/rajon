<x-layouts.app title="Registrace — Rajón">
    <div class="mx-auto max-w-lg">
        <h1 class="mb-6 text-2xl font-bold text-gray-800">Registrace</h1>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="jmeno" name="jmeno" value="{{ old('jmeno') }}" required
                ...
                <div>
                    ...
                    <input type="text" id="prijmeni" name="prijmeni" value="{{ old('prijmeni') }}" required
                        class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none">
